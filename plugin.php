...
use SolubCore\PageSettings\Page_Settings;
...
class Plugin {
	...
	public function widget_scripts() {
		wp_register_script( 'solub_core', plugins_url( '/assets/js/hello-world.js', __FILE__ ), [ 'jquery' ], false, true );
	}
...
// widget category create 
	public function solub_add_widget_categories( $solub_add_cat_manager ) {
		$solub_add_cat_manager->add_category(
			'solub-widget-category',
			[
				'title' => esc_html__( 'Solub Core', 'solub-core' ),
				'icon' => 'fa fa-plug',
			]
		);
	}
